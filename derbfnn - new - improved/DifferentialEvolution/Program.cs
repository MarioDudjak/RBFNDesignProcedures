    ...
    class Program
    {
        static void Main(string[] args)
        {
			...
			DataSet[] datasets = new DataSet[]
			{
				...
				/*Yeast,*/ Ionosphere,Banknote,Iris, Seeds,/* Cardiotochography, /*CMC,*/ Glass, HeartDisease, ILPD, Imageseg,   Liver,
				Parkinsons, Pima, Statlog, Thoracic, Thyroid, Vowel, Wbc, Wine, 
			};
            //DataSet[] datasets = new DataSet[]
            //{
            //     Ionosphere, Parkinsons, Iris, Seeds, Thyroid, Wine, Banknote
            //};
